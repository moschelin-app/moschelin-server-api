...
class SearchDetailResource(Resource):
    ...
    def get(self):
        ...
        data = request.args
        check_list = ['forcus', 'search', 'offset', 'limit']
        ...
        forcus = data.get('forcus')
        search = data.get('search')
        offset = data.get('offset')
        limit = data.get('limit')
        
                
        forcus_list = ['store', 'user', 'review', 'meeting']
        ...
        try:
            ...
            # 모임 기준일때
                ...
                return {
                    'result' : 'fail',
                    'error' : '포커스는 user, review, store, meetint 의 값만 허용됩니다.'
                }, 400
